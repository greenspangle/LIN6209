...
def contains(a_char, filename):
    """Test if a given character occurs anywhere in the file filename"""
...
if __name__ == '__main__':
    ...
    pass
    # remove_hf('244-0.txt', 'scarlet.txt')
