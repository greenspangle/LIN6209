...
def all_ops_pt1(int1, int2):
    ...
    >>> def all_ops_pt1 (int1,int2):
	"""int1 + int2, int1 - int2, int1 * int2, int1 / int2, int1 // int2, int1 % int2"""
	the_results = int1 + int2, int1 - int2, int1 * int2, int1 / int2, int1 // int2, int1 % int2
	return the_results
...
def hms_to_s(hours, minutes, seconds):
    ...
    # your code goes here
    >>> def hms_to_s(hours, minutes, seconds):
	print ('time in hours, minutes, seconds:' ,hours, minutes, seconds)
...
def s_to_hms(seconds):
    ...
    # your code goes here
   def s_to_hms (seconds):
	"""change time from hours and minutes and seconds to seconds"""
	hours=str(seconds//3600)
	minutes=str((seconds%3600)//60)
	seconds=str((seconds%3600)%60)
	d="{} hours {} minutes {} seconds".format(hours, minutes, seconds)
	return d
...
def add_hms(hr1, min1, sec1, hr2, min2, sec2):
    ...
    return  # the tuple (hours, minutes, seconds)
>>> def add_hms(hr1, min1, sec1, hr2, min2, sec2):
	"""Add two hour:minute:seconds time durations"""
	hours = hr1 +hr2
	minutes = min1 +min2
	seconds = sec1 +sec2
